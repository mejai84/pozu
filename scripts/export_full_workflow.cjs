...
const nodeIndex = data.nodes.findIndex(n => n.name === 'Extraer Datos Estructurados');
data.nodes[nodeIndex].parameters.options.systemMessage = `={{ \`ERES EL ASISTENTE DE VENTAS EXPERTO DE POZU 2.0.
...
fs.writeFileSync('c:/Users/Cesar/Downloads/Pozu_LISTO_PARA_USAR.json', JSON.stringify(data, null, 2));
