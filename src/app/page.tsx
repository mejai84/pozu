...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#111111] flex flex-col relative overflow-hidden font-sans">
      ...
      <main className="flex-1 relative z-10 flex flex-col justify-center container mx-auto px-6 lg:px-12 pt-24 pb-20">
        ...
        <div className="grid lg:grid-cols-[1.2fr_1fr] gap-8 items-center mt-12 lg:mt-4">
          ...
          <motion.div 
            ...
            className="relative w-full h-full flex justify-center items-center lg:-mr-10 xl:-mr-20 order-first lg:order-last"
          >
             <div className="relative w-full max-w-[500px] lg:max-w-[800px] aspect-square lg:aspect-[4/3]">
                <Image
        ...
        >
          ...
          <div className="bg-[#1A1A1A] border-2 border-white/60 rounded-3xl p-4 flex gap-4 items-center shadow-2xl hover:border-white transition-colors group">
            <div className="flex-1 flex flex-col items-start gap-3">
              <h3 className="text-[#E8E0D5] font-black text-xl uppercase leading-[1.1]">
          ...
          <div className="bg-[#1A1A1A] border-2 border-white/60 rounded-3xl p-4 flex gap-4 items-center shadow-2xl hover:border-white transition-colors group">
            ...
            <div className="w-28 h-24 relative rounded-xl overflow-hidden flex-shrink-0 bg-neutral-800">
               <Image src="/images/burgers/pozu.png" alt="Sides" fill className="object-cover group-hover:scale-110 transition-transform duration-500 grayscale brightness-75 drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]" />
            </div>
          </div>
          ...
          <div className="bg-[#1A1A1A] border-2 border-white/60 rounded-3xl p-4 flex gap-4 items-center shadow-2xl hover:border-white transition-colors group">
            ...
            <div className="w-28 h-24 relative rounded-xl overflow-hidden flex-shrink-0 bg-neutral-800">
               <Image src="/images/burgers/pozu.png" alt="Combos" fill className="object-cover group-hover:scale-110 transition-transform duration-500 sepia brightness-90 drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]" />
            </div>
          </div>
        </motion.div>
      ...
      {/* Floating Buttons */}
      <div className="fixed bottom-24 right-6 flex flex-col gap-4 z-50 items-end">
        <a href="https://wa.me/34600000000" target="_blank" rel="noreferrer" className="w-14 h-14 bg-[#25D366] rounded-full shadow-[0_0_20px_rgba(37,211,102,0.4)] flex items-center justify-center hover:scale-110 transition-transform cursor-pointer border border-white/20">
        ...
        <button className="flex items-center gap-3 bg-[linear-gradient(180deg,#3b3b3b,#1f1f1f)] border border-white/20 px-5 py-2.5 rounded-full shadow-[0_10px_20px_rgba(0,0,0,0.5)] hover:scale-105 transition-transform">
